function BZdiagram()
    ...
    plot(0,2,'diamond','MarkerFaceColor',[0 0.4470 0.7410],'MarkerEdgeColor',[0 0.4470 0.7410],'MarkerSize',12);
    plot(-2,1,'diamond','MarkerFaceColor',[0 0.4470 0.7410],'MarkerEdgeColor',[0 0.4470 0.7410],'MarkerSize',12);
    plot(-2,-1,'diamond','MarkerFaceColor',[0 0.4470 0.7410],'MarkerEdgeColor',[0 0.4470 0.7410],'MarkerSize',12);
    plot(0,-2,'diamond','MarkerFaceColor',[0 0.4470 0.7410],'MarkerEdgeColor',[0 0.4470 0.7410],'MarkerSize',12);
    plot(2,-1,'diamond','MarkerFaceColor',[0 0.4470 0.7410],'MarkerEdgeColor',[0 0.4470 0.7410],'MarkerSize',12);
    plot(4,0,'square','MarkerEdgeColor',[0.4660 0.6740 0.1880],'MarkerFaceColor',[0.4660 0.6740 0.1880],'MarkerSize',12);
    plot(2,3,'square','MarkerEdgeColor',[0.4660 0.6740 0.1880],'MarkerFaceColor',[0.4660 0.6740 0.1880],'MarkerSize',12);
    plot(-2,3,'square','MarkerEdgeColor',[0.4660 0.6740 0.1880],'MarkerFaceColor',[0.4660 0.6740 0.1880],'MarkerSize',12);
    plot(0,4,'v','MarkerEdgeColor',[0.4940 0.1840 0.5560],'MarkerFaceColor',[0.4940 0.1840 0.5560],'MarkerSize',12);
    plot(0,-4,'v','MarkerEdgeColor',[0.4940 0.1840 0.5560],'MarkerFaceColor',[0.4940 0.1840 0.5560],'MarkerSize',12);
    plot(-2,-3,'o','MarkerFaceColor','k','MarkerEdgeColor','k');
    ...
    %text(-0.4,-0.3,'(0,0)','FontSize',14);
    %text(1.6,0.7,'(1,1)','FontSize',14);
    %text(-0.4,3.6,'(0,2)','FontSize',14);
    %text(3,0,'(2,1)','FontSize',14);
    %grid on; grid minor;
end